...
用法:
  python auto_label.py --model path/to/best.pt --images screenshots/

输出:
  yolo_dataset/labels/auto/  — 自动生成的标注文件
  yolo_dataset/images/auto/  — 对应的图片（软链接）
"""
...
def auto_label(model_path: str, image_dir: str, conf: float = 0.5):
    ...
    print("请人工检查修正后移动到 labels/train/")
